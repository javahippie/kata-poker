...
Small Clojure implementation of the [KataPokerHands](http://codingdojo.org/cgi-bin/index.pl?KataPokerHands). This is completely useless and was coded for fun only (and to learn the language better).

## The task
### About this Kata
This kata is blatantly stolen from acm.uva.es/p/v103/10315.html It is a
subset of [KataTexasHoldEm](http://codingdojo.org/cgi-bin/index.pl?KataTexasHoldEm), which is a very
large Kata.
